...
namespace fuliu.pseudocode
{
    ...
    public class Pseudocode : IEnumerator
    {
        ...
        /// <summary>
        /// 第三个参数 Action<object> 中的 object 是 方法的返回值
        /// 第四个参数 object[] 是 表中所填的参数
        /// 第五个参数 object[] 是 调用的地方传的参数
        /// </summary>
        public Action<Pseudocode, string, Action<object>, object[], object[]> onCallFunc;
        ...
        public Pseudocode(Action<Pseudocode, string, Action<object>, object[], object[]> onCallFunc)
        {
            this.onCallFunc = onCallFunc;
        }
        
        public Pseudocode(Action<Pseudocode, string, Action<object>, object[], object[]> onCallFunc, string script, IParser parser = null)
        {
            this.onCallFunc = onCallFunc;
            this.script = script;
            if (parser != null)
        ...
        public void Run(Action callback = null, params object[] commonParams)
        {
            if (funcs != null)
            {
                if (funcs.Length > 0)
        ...
        public void Run(PseudocodeFunc pseudocodeFunc, Action callback, params object[] commonParams)
        {
                ...
                if (pseudocodeFunc.funcParamFuncs != null && pseudocodeFunc.funcParamFuncs.Length > 0)
                {
                    ...
                    RunParamQueue(pseudocodeFunc, callQueue, () =>
                    {
                        onCallFunc(this, pseudocodeFunc.funcName, (res) =>
                        {
                            ...
                            callback?.Invoke();
                        }, pseudocodeFunc.paramResults, commonParams);
                    }, commonParams);
                }
                else
                {
        ...
        public void RunAll(object[] commonParams)
        {
            RunQueue(GetFuncParamFuncsQueue(funcs), null, commonParams);
        }

        public void RunQueue(Queue<PseudocodeFunc> callQueue, Action callback, object[] commonParams)
        {
            RunParamQueue(null, callQueue, callback, commonParams);
        }
            ...
            if (callQueue.Count > 0)
            {
                ...
                if (func.needCompute)
                {
                    Run(func, () =>
                    {
                        ...
                        // 递归
                        RunParamQueue(pseudocodeFunc, callQueue, callback, commonParams);
                    }, commonParams);
                }
                else
                {
    ...
    public class PseudocodeAction
    {
        ...
        public static implicit operator bool(PseudocodeAction exists)
        {
            return exists != null;
        }
    }
