...
namespace fuliu.pseudocode
{
    public static class PseudocodeHelper
    {
        ...
        public static void Run(string pseudocodeStr, Action callback = null, params object[] commonParams)
        {
            new Pseudocode(onCallFunc, pseudocodeStr, new CPseudocodeParser()).Run(callback, commonParams);
        }

        /// <summary>
        /// 可通过协程中 yeild return 来调用
        /// </summary>
        public static IEnumerator RunCode(string pseudocodeStr, params object[] commonParams)
        {
