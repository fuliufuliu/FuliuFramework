...
namespace UnityEngine.UI
{
    ...
    [AddComponentMenu("UI/Super Scroll Rect", 36)]
    [SelectionBase]
    [ExecuteAlways]
    ...
    /// </remarks>
    public class SuperScollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        /// <summary>
        ...
        [SerializeField]
        public float circleRedius = 100f;
        ...
        public virtual void OnDrag(PointerEventData eventData)
        {
            ...
            if (m_MovementType != MovementType.Circle)
            {
            ...
            {
                pointerDelta = Vector2.ClampMagnitude(pointerDelta, circleRedius);
                position = m_ContentStartPosition + pointerDelta;
//                Vector2 offset = CalculateOffset(position - m_Content.anchoredPosition);
//                offset = Vector2.ClampMagnitude(offset, minWidth);
//                position += offset;
            }
        ...
        protected virtual void LateUpdate()
        {
            ...
            if (m_ViewBounds != m_PrevViewBounds || m_ContentBounds != m_PrevContentBounds || m_Content.anchoredPosition != m_PrevPosition)
            {
                ...
                m_OnValueChanged.Invoke(offset, deltaOffset);
                UpdatePrevData();
            }
